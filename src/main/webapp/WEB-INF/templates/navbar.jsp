    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <% if (request.getServletPath().equals("/WEB-INF/pages/users_list.jsp")) { %> disabled <% } else {%>active<%}%>" aria-current="page" href="/users">Manage users</a>
                </li>
                <% } %>
            </ul>
            <form class="d-flex">
                ...
                <span class="navbar-text me-2">
                  Welcome, <a class="nav-link d-inline ps-0 <% if (request.getServletPath().equals("/WEB-INF/pages/profile_self.jsp")) { %> disabled <% } else {%>active<%}%>" href="/profile">
                    <%= user.getName() %>
                </a>
                </span>
